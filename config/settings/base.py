...
)  # (student_registration/config/settings/base.py - 3 = student_registration/)
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {"sites": "student_registration.contrib.sites.migrations"}
...
UNIQUE_ID_API_TOKEN_URL = env(
    "UNIQUE_ID_API_TOKEN_URL",
    default="https://leb-cash-ims.azurewebsites.net/cashmis/api/auth/getAccessToken",
)
UNIQUE_ID_API_URL = env(
    "UNIQUE_ID_API_URL",
    default="https://leb-cash-ims.azurewebsites.net/cashmis/api/Request/getIndividualsUniqueIDs",
)
UNIQUE_PROGRAMMES_API_URL = env(
    "UNIQUE_PROGRAMMES_API_URL",
    default="https://leb-cash-ims.azurewebsites.net/cashmis/api/Request/getIndividualsProgrammes",
)
