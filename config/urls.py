...
from student_registration.ai.views import VannaQueryViewSet
...
api.register(r'vanna', VannaQueryViewSet, basename='vanna')
...
urlpatterns = [
    ...
    re_path(r'^ai/', include(('student_registration.ai.urls', 'ai'), namespace='ai')),
