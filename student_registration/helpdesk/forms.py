...
from student_registration.helpdesk.lib import send_templated_mail, safe_template_context, process_attachments
from student_registration.helpdesk.models import (Ticket, Queue, FollowUp, Attachment, IgnoreEmail, TicketCC,
...
class AbstractTicketForm(CustomFieldMixin, forms.Form):
    ...
    def _create_ticket(self):
        ...
        owner = User.objects.get(id=int(self.cleaned_data['owner']))
