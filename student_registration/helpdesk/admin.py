...
from student_registration.helpdesk.models import Queue, Ticket, FollowUp, PreSetReply, KBCategory
from student_registration.helpdesk.models import EscalationExclusion, EmailTemplate, KBItem
from student_registration.helpdesk.models import TicketChange, Attachment, IgnoreEmail
from student_registration.helpdesk.models import CustomField
...
class TicketAdmin(admin.ModelAdmin):
    ...
    def school(self, obj):
        if obj.owner and obj.owner.school:
            return obj.owner.school.name
        return ''

    def school_cerd(self, obj):
        if obj.owner and obj.owner.school:
            return obj.owner.school.number
        return ''
