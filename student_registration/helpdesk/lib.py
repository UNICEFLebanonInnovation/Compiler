...
from student_registration.helpdesk.models import Attachment, EmailTemplate
...
def send_templated_mail(template_name,
    ...
    from student_registration.helpdesk.models import EmailTemplate
    from student_registration.helpdesk.settings import HELPDESK_EMAIL_SUBJECT_TEMPLATE, \
...
def text_is_spam(text, request):
    ...
    try:
        from student_registration.helpdesk.akismet import Akismet
    except:
        return False
    try:
