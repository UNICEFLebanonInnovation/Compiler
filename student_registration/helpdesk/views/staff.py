...
def ticket_list(request):
    ...
    if request.GET.get('saved_query', None):
        ...
        import json
        from student_registration.helpdesk.lib import b64decode
        try:
            if six.PY3:
    ...
    import json
    from student_registration.helpdesk.lib import b64encode
