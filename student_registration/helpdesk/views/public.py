...
from student_registration.helpdesk.decorators import protect_view
from student_registration.helpdesk.forms import PublicTicketForm
from student_registration.helpdesk.lib import text_is_spam
from student_registration.helpdesk.models import Ticket, Queue, UserSettings, KBCategory
    ...
    if ticket_req and email:
        ...
        try:
            ...
            if 'close' in request.GET and ticket.status == Ticket.RESOLVED_STATUS:
                from student_registration.helpdesk.views.staff import update_ticket
