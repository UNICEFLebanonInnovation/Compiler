...
class EnrollmentTable(tables.Table):
    image_column = tables.TemplateColumn(verbose_name=_('upload image'), orderable=False,
                                        template_name='enrollments/image_column.html',
                                        attrs={'url': '/enrollments/saveimage/'})
