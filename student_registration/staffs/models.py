...
class Staffs(models.Model):
    ...
    sex = models.CharField(
        max_length=50, blank=True, null=True, choices=GENDER, verbose_name=_("Sex")
    )
    ...
    place_of_birth = models.CharField(
        max_length=200, blank=True, null=True, verbose_name=_("Place of birth")
    )
    ...
    phone = models.CharField(
        max_length=24, blank=True, null=True, verbose_name=_("Phone number")
    )
    ...
    automated_nb = models.CharField(
        max_length=15, blank=True, null=True, verbose_name=_("Automated Nb")
    )
    financial_nb = models.CharField(
        max_length=20, blank=True, null=True, verbose_name=_("Financial Nb")
    )
    ...
    speciality = models.CharField(
        max_length=70, blank=True, null=True, verbose_name=_("Speciality")
    )
    cert_origin = models.CharField(
        max_length=70, blank=True, null=True, verbose_name=_("Speciality")
    )
    pic_identification = models.CharField(
        max_length=200, blank=True, null=True, verbose_name=_("Picture of Identy")
    )
    ...
    pic_iban = models.CharField(
        max_length=200, blank=True, null=True, verbose_name=_("Picture of the iban")
    )
...
class ParticipantYear(models.Model):
    ...
    participantyear = models.CharField(
        max_length=9, blank=True, null=True, choices=SELECTYEAR
    )
