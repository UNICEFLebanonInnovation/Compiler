...
class Child(TimeStampedModel):
    ...
    HAVE_CHILDREN = Choices(
        ...
        (
            ...
            _("Child pregnant or expecting children"),
        ),
    )
    ...
    LIVING_ARRANGEMENT = Choices(
        ...
        (
            ...
            _("Married and living with extended family"),
        ),
    )
    ...
    gender = models.CharField(
        max_length=50, blank=True, null=True, choices=GENDER, verbose_name=_("Gender")
    )
    ...
    address = models.TextField(
        blank=True, null=True, verbose_name=_("Registered child Home Address")
    )
    ...
    unicef_id = models.CharField(
        max_length=45, blank=True, null=True, verbose_name=_("Unicef ID")
    )
    ...
    case_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("UNHCR Case number")
    )
    ...
    parent_individual_case_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Parent individual ID")
    )
    ...
    individual_case_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Child individual ID")
    )
    ...
    recorded_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("UNHCR recorded barcode")
    )
    ...
    national_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Child Lebanese ID number")
    )
    ...
    parent_syrian_national_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Parent Syrian ID number ")
    )
    ...
    syrian_national_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Child Syrian ID number")
    )
    ...
    other_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("ID number of the child")
    )
    ...
    first_phone_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Primary phone number")
    )
    ...
    def calculate_age(self):
        ...
        age = today - datetime.datetime(
            int(self.birthday_year), int(self.birthday_month), int(self.birthday_day)
        )
        years = age.days // 365
