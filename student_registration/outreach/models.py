...
class HouseHold(models.Model):
    ...
    barcode_number = models.CharField(
        max_length=45, blank=True, null=True, db_index=True
    )
...
class Child(Person):
    ...
    barcode_subset = models.CharField(
        max_length=45, blank=True, null=True, db_index=True
    )
...
class OutreachCaregiver(models.Model):
    ...
    caregiver_nationality_other = models.CharField(
...
class OutreachChild(models.Model):
    ...
    birthday_month = models.CharField(
        max_length=2, blank=True, null=True, default=0, choices=MONTHS
    )
