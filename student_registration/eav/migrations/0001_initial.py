# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-08-18 12:01
...
import student_registration.eav.fields
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', student_registration.eav.fields.EavSlugField(help_text='Short unique attribute label', verbose_name='slug')),
                ...
                ('datatype', student_registration.eav.fields.EavDatatypeField(choices=[(b'text', 'Text'), (b'float', 'Float'), (b'int', 'Integer'), (b'date', 'Date'), (b'bool', 'True / False'), (b'object', 'Django Object'), (b'enum', 'Multiple Choice')], max_length=6, verbose_name='data type')),
