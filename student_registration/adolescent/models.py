...
class Adolescent(TimeStampedModel):
    ...
    address = models.TextField(
        blank=True, null=True, verbose_name=_("Registered youth Home Address")
    )
    ...
    individual_case_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Youth individual ID")
    )
    ...
    national_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Youth Lebanese ID number")
    )
    ...
    syrian_national_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Youth Syrian ID number")
    )
    ...
    other_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("ID number of the youth")
    )
    ...
    unrwa_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("UNRWA Case number")
    )
