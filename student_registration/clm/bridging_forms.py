...
YEARS = list(
    ((str(x), x) for x in range(Person.CURRENT_YEAR - 20, Person.CURRENT_YEAR - 2))
)
YEARS.insert(0, ("", "---------"))
...
class CommonForm(forms.ModelForm):
    ...
    search_clm_student = forms.CharField(
        label=_("Search a student"), widget=forms.TextInput, required=False
    )
    ...
    student_first_name = forms.CharField(
        label=_("First name"), widget=forms.TextInput, required=True
    )
    student_father_name = forms.CharField(
        label=_("Father name"), widget=forms.TextInput, required=True
    )
    student_last_name = forms.CharField(
        label=_("Last name"), widget=forms.TextInput, required=True
    )
    ...
    student_birthday_month = forms.ChoiceField(
        label=_("Birthday month"), widget=forms.Select, required=True, choices=MONTHS
    )
    student_birthday_day = forms.ChoiceField(
        label=_("Birthday day"), widget=forms.Select, required=True, choices=DAYS
    )
    student_nationality = forms.ModelChoiceField(
        label=_("Nationality"),
        queryset=Nationality.objects.exclude(id=9),
        widget=forms.Select,
        required=True,
        to_field_name="id",
    )
    ...
    student_mother_fullname = forms.CharField(
        label=_("Mother fullname"), widget=forms.TextInput, required=True
    )
    ...
    disability = forms.ModelChoiceField(
        queryset=Disability.objects.filter(active=True),
        widget=forms.Select,
    ...
    hh_educational_level = forms.ModelChoiceField(
        queryset=EducationalLevel.objects.exclude(id=3),
        widget=forms.Select,
    ...
    caretaker_first_name = forms.CharField(
        label=_("Caregiver First Name"), widget=forms.TextInput, required=False
    )
    caretaker_middle_name = forms.CharField(
        label=_("Caregiver Middle Name"), widget=forms.TextInput, required=False
    )
    caretaker_last_name = forms.CharField(
        label=_("Caregiver Last Name"), widget=forms.TextInput, required=False
    )
    caretaker_mother_name = forms.CharField(
        label=_("Caregiver Mother Name"), widget=forms.TextInput, required=False
    )
        ...
        if instance:
            ...
            if serializer.is_valid():
                instance = serializer.update(
                    validated_data=serializer.validated_data, instance=instance
                )
                instance.modified_by = request.user
                instance.save()
                request.session["instance_id"] = instance.id
                messages.success(
                    request, _("Your data has been sent successfully to the server")
                )
            else:
...
class BridgingForm(CommonForm):
    ...
    YEARS_Bridging = list(
        ((str(x), x) for x in range(Person.CURRENT_YEAR - 20, Person.CURRENT_YEAR - 5))
    )
    ...
    first_attendance_date = forms.DateField(
        label=_("First attendance date"), required=False
    )
    ...
    round = forms.ModelChoiceField(
        queryset=CLMRound.objects.filter(current_round_bridging=True),
        widget=forms.Select,
    ...
    round_start_date = forms.DateField(label=_("Round start date"), required=False)
    ...
    labours_other_specify = forms.CharField(
        label=_(
            "Please specify(hotel, restaurant, transport, personal services such as cleaning, "
    ...
    education_status = forms.ChoiceField(
        ...
        choices=(
            (
                ...
                _("Not Registered in any school before"),
            ),
            ...
            (
                ...
                _("Was registered in ALP program and didnt continue"),
            ),
        ),
        initial="",
    )
    ...
    other_nationality = forms.CharField(
        label=_("Specify the nationality"), widget=forms.TextInput, required=False
    )
    ...
    id_type = forms.ChoiceField(
        ...
        widget=forms.Select(
            attrs=({"translation": _("Child no ID confirmation popup message")})
        ),
        required=True,
        choices=(
            ("", "----------"),
    ...
    individual_case_number = forms.RegexField(
        ...
        widget=forms.TextInput(attrs={"placeholder": "Format: XXX-XXXXXXXX"}),
        required=False,
        label=_("Individual ID of the Child from the certificate"),
    )
    ...
    recorded_number = forms.RegexField(
        ...
        widget=forms.TextInput(
            attrs={"placeholder": "Format: LEB-XXCXXXXX or LB-XXX-XXXXXX"}
        ),
        required=False,
    ...
    syrian_national_number = forms.RegexField(
        regex=r"^\d{11}$", required=False, label=_("National ID number of the child")
    )
    ...
    sop_national_number = forms.CharField(
        required=False, label=_("Palestinian ID number of the child")
    )
    sop_national_number_confirm = forms.CharField(
        required=False, label=_("Confirm Palestinian ID number of the child")
    )
    ...
    # )
    other_number = forms.CharField(required=False, label=_(" ID number of the child"))
    other_number_confirm = forms.CharField(
        required=False, label=_("Confirm ID number of the child")
    )
    individual_extract_record = forms.CharField(
        required=False, label=_("Lebanese Extract of Record of the child")
    )
    individual_extract_record_confirm = forms.CharField(
        required=False, label=_("Confirm Lebanese Extract of Record of the child")
    )

    no_child_id_confirmation = forms.CharField(widget=forms.HiddenInput, required=False)
    no_parent_id_confirmation = forms.CharField(
    ...
    source_of_identification = forms.ChoiceField(
        ...
        choices=(
            ...
            (
                ...
                _("Referred by the municipality / Other formal sources"),
            ),
    ...
    source_of_identification_specify = forms.CharField(
        label=_("Please specify"), widget=forms.TextInput, required=False
    )
    rims_case_number = forms.CharField(required=False, label=_("RIMS Case Number"))
    ...
    consent_parents = forms.FileField(
        label=_("Consent from parents"), required=False, widget=CustomClearableFileInput
    )
    ...
    enrolled_formal_education = forms.ChoiceField(
        label=_(
            "Was this child enrolled in Formal Education last year and dropped out due to lack of documentation?"
        ),
        widget=forms.Select,
        required=True,
        choices=CLM.YES_NO,
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not is_Kayany:
            ...
            years = list(
                (
                    (str(y), y)
                    for y in range(Person.CURRENT_YEAR - 15, Person.CURRENT_YEAR - 5)
                )
            )
            years.insert(0, ("", "---------"))
            ...
            self.helper.layout = Layout(
                ...
                Div(
                    ...
                    Div(
                        ...
                        HTML(
                            '<span class="badge-form badge-pill" id="span_other_nationality">7</span>'
                        ),
                    ...
                    Div(
                        ...
                        HTML(
                            '<span class="badge-form-2 badge-pill" id="span_miss_school_date">14</span>'
                        ),
                    ...
                    Div(
                        HTML(
                            '<span class="badge-form-2 badge-pill" id="span_rims_case_number">17</span>'
                        ),
                ...
                Div(
                    ...
                    Div(
                        ...
                        HTML(
                            '<span class="badge-form-2 badge-pill" id="span_other_caregiver_relationship">10</span>'
                        ),
                ...
                Div(
                    Div(
                        ...
                        HTML(
                            '<span class="badge-form badge-pill" id=span_student_have_children">2</span>'
                        ),
                        Div(
                            "student_have_children",
                            css_class="col-md-4",
                            css_id="student_have_children",
                        ),
                        HTML(
                            '<span class="badge-form badge-pill" id="span_student_number_children">3</span>'
                        ),
                    ...
                    Div(
                        ...
                        HTML(
                            '<span class="badge-form badge-pill" id="span_labours_other_specify">6</span>'
                        ),
                    ...
                    Div(
                        HTML('<span class="badge-form badge-pill">7</span>'),
                        Div(
                            "labour_hours", css_class="col-md-3", css_id="labour_hours"
                        ),
                        HTML('<span class="badge-form badge-pill">8</span>'),
        ...
        if clm_bridging_all:
            ...
            queryset = School.objects.filter(
                is_closed=False,
                id__in=PartnerOrganization.objects.filter(id=partner_id).values_list(
                    "schools", flat=True
                ),
            )
        else:
    ...
    def clean(self):
        ...
        if year and month and day:
            try:
                ...
                self.add_error(
                    "student_birthday_year", "The entered date is not valid."
                )
        ...
        individual_case_number_confirm = cleaned_data.get(
        ...
        syrian_national_number_confirm = cleaned_data.get(
        ...
        individual_extract_record_confirm = cleaned_data.get(
        ...
        main_caregiver_nationality_other = cleaned_data.get(
        ...
        source_of_identification_specify = cleaned_data.get(
        ...
        if source_of_identification == "Other Sources":
            if not source_of_identification_specify:
                self.add_error(
                    "source_of_identification_specify", "This field is required"
                )
        ...
        if main_caregiver_nationality and main_caregiver_nationality.id == 6:
            if not main_caregiver_nationality_other:
                self.add_error(
                    "main_caregiver_nationality_other", "This field is required"
                )
        ...
        if id_type == "Syrian national ID":
            ...
            if not syrian_national_number_confirm:
                self.add_error(
                    "syrian_national_number_confirm", "This field is required"
                )
            ...
            if (
                syrian_national_number_confirm
                and not len(syrian_national_number_confirm) == 11
            ):
                msg = "Please enter a valid number (11 digits)"
    ...
    def save(self, request=None, instance=None, serializer=None):
        ...
        instance = super(BridgingForm, self).save(
            request=request, instance=instance, serializer=BridgingSerializer
        )
        if not instance:
            return None
        instance.save()
...
class BridgingPreAssessmentForm(forms.ModelForm):
        ...
        if not is_Kayany:
            self.helper.layout = Layout(
                Div(
                    Div(
                        HTML(
                            '<h4 id="alternatives-to-hidden-labels">'
                            + _("Pre-Assessment")
                            + "</h4>"
                        ),
                        css_class="row card-body",
                    ...
                    Div(
                        HTML('<span class="badge-form badge-pill">1</span>'),
                        HTML("<h6>English/French</h6>"),
                        css_class="row card-body",
                    ),
                    Div(
                        Div("ef_letter_sound", css_class="col-md-3"),
                        Div("ef_familiar_words", css_class="col-md-3"),
                        Div("ef_picture_word_matching", css_class="col-md-3"),
                        Div("ef_reading_comprehension_text_1", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        Div("ef_reading_comprehension_text_2", css_class="col-md-3"),
                        Div("ef_letter_dictation", css_class="col-md-3"),
                        Div("ef_word_dictation", css_class="col-md-3"),
                        Div("ef_sentence_dictation", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        Div("ef_picture_naming", css_class="col-md-3"),
                        Div("ef_picture_description", css_class="col-md-3"),
                        Div("ef_total_score", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        HTML('<span class="badge-form badge-pill">2</span>'),
                    ...
                    Div(
                        Div("ar_letter_sound", css_class="col-md-3"),
                        Div("ar_alphabet_vowel_marks", css_class="col-md-3"),
                        Div("ar_alphabet_long_vowels", css_class="col-md-3"),
                        Div("ar_familiar_words", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        Div("ar_picture_word_matching", css_class="col-md-3"),
                        Div("ar_reading_comprehension_text_1", css_class="col-md-3"),
                        Div("ar_reading_comprehension_text_2", css_class="col-md-3"),
                        Div("ar_letter_dictation", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        Div("ar_word_dictation", css_class="col-md-3"),
                        Div("ar_sentence_dictation", css_class="col-md-3"),
                        Div("ar_picture_naming", css_class="col-md-3"),
                        Div("ar_picture_description", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        Div("ar_total_score", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        HTML('<span class="badge-form badge-pill">3</span>'),
                    ...
                    Div(
                        Div("m_natural_numbers", css_class="col-md-3"),
                        Div("m_addition", css_class="col-md-3"),
                        Div("m_location", css_class="col-md-3"),
                        Div("m_plane_figures", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        Div("m_subtraction", css_class="col-md-3"),
                        Div("m_length", css_class="col-md-3"),
                        Div("m_solid_figures", css_class="col-md-3"),
                        Div("m_multiplication", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        Div("m_division", css_class="col-md-3"),
                        Div("m_fractions", css_class="col-md-3"),
                        Div("m_total_score", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    FormActions(
                        Submit(
            ...
            self.helper.layout = Layout(
                Div(
                    ...
                    Div(
                        HTML(
                            '<span class="badge-form badge-pill" id="span_exam1">1</span>'
                        ),
    ...
    def _validate_level_scores(self, cleaned_data):
        level = cleaned_data.get("registration_level")
        ef = {
            "level_one": [
                ("ef_letter_sound", 10),
                ("ef_familiar_words", 5),
                ("ef_picture_word_matching", 5),
                ("ef_reading_comprehension_text_1", 5),
                ("ef_reading_comprehension_text_2", 5),
                ("ef_letter_dictation", 5),
                ("ef_word_dictation", 5),
            ],
            "level_two": [
                ("ef_letter_sound", 10),
            ...
            "level_three": [
                ...
                ("ef_reading_comprehension_text_2", 5),
                ("ef_word_dictation", 5),
                ("ef_picture_description", 5),
            ],
        }
        ar = {
            "level_one": [
                ("ar_letter_sound", 10),
                ("ar_alphabet_vowel_marks", 5),
                ("ar_alphabet_long_vowels", 5),
                ("ar_familiar_words", 5),
                ("ar_picture_word_matching", 5),
                ("ar_reading_comprehension_text_1", 5),
                ("ar_reading_comprehension_text_2", 5),
                ("ar_letter_dictation", 5),
                ("ar_word_dictation", 5),
            ],
            "level_two": [
                ("ar_letter_sound", 10),
            ...
            "level_three": [
                ...
                ("ar_reading_comprehension_text_1", 5),
                ("ar_reading_comprehension_text_2", 5),
                ("ar_sentence_dictation", 5),
                ("ar_picture_description", 5),
            ],
        }
        math = {
            "level_one": [
                ("m_natural_numbers", 10),
                ("m_addition", 5),
                ("m_location", 5),
                ("m_plane_figures", 5),
            ],
        ...
        totals = {
            "level_one": (40, 50, 25),
            "level_two": (40, 50, 35),
            "level_three": (40, 50, 45),
        }

        for group in [ef.get(level, []), ar.get(level, []), math.get(level, [])]:
            for field, max_value in group:
                value = cleaned_data.get(field)
                if value is None:
                    self.add_error(field, "This field is required")
                elif value > max_value:
                    self.add_error(field, "This value is greater that %s" % max_value)

        expected = totals.get(level)
        if expected:
            if cleaned_data.get("ef_total_score") is None:
                self.add_error("ef_total_score", "This field is required")
            elif cleaned_data.get("ef_total_score") > expected[0]:
                self.add_error(
                    "ef_total_score", "This value is greater that %s" % expected[0]
                )
            if cleaned_data.get("ar_total_score") is None:
                self.add_error("ar_total_score", "This field is required")
            elif cleaned_data.get("ar_total_score") > expected[1]:
                self.add_error(
                    "ar_total_score", "This value is greater that %s" % expected[1]
                )
            if cleaned_data.get("m_total_score") is None:
                self.add_error("m_total_score", "This field is required")
            elif cleaned_data.get("m_total_score") > expected[2]:
                self.add_error(
                    "m_total_score", "This value is greater that %s" % expected[2]
                )
    ...
    def clean(self):
        ...
        if self.request.user.partner and not self.request.user.partner.is_Kayany:
            self._validate_level_scores(cleaned_data)
        else:
    ...
    def save(self, instance=None, request=None):
        ...
        is_kayany = bool(request.user.partner and request.user.partner.is_Kayany)
        if is_kayany:
            instance.pre_test = {"Bridging_ASSESSMENT/exam1": request.POST.get("exam1")}
        else:
            payload = {"Bridging_ASSESSMENT/exam1": request.POST.get("exam1")}
            fields = [
                "ef_letter_sound",
                "ef_familiar_words",
                "ef_picture_word_matching",
                "ef_reading_comprehension_text_1",
                "ef_reading_comprehension_text_2",
                "ef_letter_dictation",
                "ef_word_dictation",
                "ef_sentence_dictation",
                "ef_picture_naming",
                "ef_picture_description",
                "ef_total_score",
                "ar_letter_sound",
                "ar_alphabet_vowel_marks",
                "ar_alphabet_long_vowels",
                "ar_familiar_words",
                "ar_picture_word_matching",
                "ar_reading_comprehension_text_1",
                "ar_reading_comprehension_text_2",
                "ar_letter_dictation",
                "ar_word_dictation",
                "ar_sentence_dictation",
                "ar_picture_naming",
                "ar_picture_description",
                "ar_total_score",
                "m_natural_numbers",
                "m_addition",
                "m_location",
            ...
            for field in fields:
                payload[f"Bridging_ASSESSMENT/{field}"] = request.POST.get(field)
...
class BridgingAssessmentForm(forms.ModelForm):
    ...
    dropout_reason = forms.CharField(
        label=_("Dropout reason"), widget=forms.TextInput, required=False
    )
    dropout_date = forms.DateField(label=_("Dropout date"), required=False)
    ...
    barriers_single = forms.ChoiceField(
        label=_(
            "The main barriers affecting the daily attendance and performance of the child or drop out of programme?"
        ),
        choices=CLM.BARRIERS,
        widget=forms.Select,
        required=False,
    ...
    def __init__(self, *args, **kwargs):
        ...
        instance = kwargs["instance"] if "instance" in kwargs else ""
        form_action = reverse(
            "clm:bridging_post_assessment", kwargs={"pk": instance.id}
        )
        is_Kayany = False
        if self.request.user.partner:
            is_Kayany = self.request.user.partner.is_Kayany
        ...
        self.helper.form_show_labels = True
        self.helper.form_action = form_action
        # Keep the non-grade layout as before and replace grades block
        if not is_Kayany:
            grade_layout = [
                Div(
                    HTML('<span class="badge-form badge-pill">1</span>'),
                    HTML("<h6>English/French</h6>"),
                    css_class="row card-body grades",
                ),
                Div(
                    Div("ef_letter_sound", css_class="col-md-3"),
                    Div("ef_familiar_words", css_class="col-md-3"),
            ...
            self.helper.layout = Layout(
                Div(
                    ...
                    Div(
                        ...
                        HTML(
                            '<span class="badge-form badge-pill" id="span_barriers_single">2</span>'
                        ),
                        Div("barriers_single", css_class="col-md-4"),
                        HTML(
                            '<span class="badge-form badge-pill" id="span_barriers_other">3</span>'
                        ),
                    ...
                    Div(
                        HTML(
                            '<span class="badge-form badge-pill" id="span_community_Liaison_follow_up">4</span>'
                        ),
                        Div("community_Liaison_follow_up", css_class="col-md-4"),
                        HTML(
                            '<span class="badge-form badge-pill" id="span_community_liaison_specify">5</span>'
                        ),
                    ...
                    Div(
                        ...
                        Div("test_done", css_class="col-md-3"),
                        HTML(
                            '<span class="badge-form badge-pill" id="span_round_complete">7</span>'
                        ),
                        Div("round_complete", css_class="col-md-3"),
                        css_class="row card-body",
                    ),
                    Div(
                        ...
                        HTML(
                            '<span class="badge-form badge-pill" id="span_learning_result_other">9</span>'
                        ),
                    ...
                    Div(
                        HTML(
                            '<span class="badge-form-2 badge-pill" id="span_dropout_reason">10</span>'
                        ),
                        Div("dropout_reason", css_class="col-md-3"),
                        HTML(
                            '<span class="badge-form-2 badge-pill" id="span_dropout_date">11</span>'
                        ),
                    ...
                    Div(
                        HTML(
                            '<span class="badge-form-2 badge-pill" id="span_referral_school">12</span>'
                        ),
                        Div("referral_school", css_class="col-md-4"),
                        HTML(
                            '<span class="badge-form-2 badge-pill" id="span_referral_school_type">13</span>'
                        ),
                    ...
                    Div(
                        HTML(
                            '<span class="badge-form-2 badge-pill" id="span_exam3">14</span>'
                        ),
    ...
    def _validate_level_scores(self, cleaned_data):
        ...
        expected = totals.get(level)
        if expected:
            for field, max_total in [
                ("ef_total_score", expected[0]),
                ("ar_total_score", expected[1]),
                ("m_total_score", expected[2]),
            ]:
                value = cleaned_data.get(field)
                if value is None:
                    self.add_error(field, "This field is required")
                elif value > max_total:
                    self.add_error(field, "This value is greater that %s" % max_total)

    def clean(self):
        cleaned_data = super(BridgingAssessmentForm, self).clean()
        if cleaned_data.get("test_done") == "yes":
            if self.request.user.partner and not self.request.user.partner.is_Kayany:
                self._validate_level_scores(cleaned_data)
            else:
    ...
    def save(self, instance=None, request=None):
        ...
        if is_kayany:
            ...
            payload = {"Bridging_ASSESSMENT/exam3": request.POST.get("exam3")}
            fields = [
                "ef_letter_sound",
                "ef_familiar_words",
                "ef_picture_word_matching",
...
class BridgingMidAssessmentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        form_action = reverse(
            "clm:bridging_mid_assessment", kwargs={"pk": instance.id, "number": number}
        )
        header_text = "Mid Test 1" if not is_Kayany else "Exam 2"
        ...
        if not is_Kayany:
            ...
            self.helper.layout = Layout(
                Div(
                    ...
                    Div(
                        HTML(
                            '<span class="badge-form badge-pill" id="span_exam2">2</span>'
                        ),
    ...
    def clean(self):
        ...
        if mid_test_done == "yes":
            if self.request.user.partner and not self.request.user.partner.is_Kayany:
                ef_letter_sound = cleaned_data.get("ef_letter_sound")
                ef_familiar_words = cleaned_data.get("ef_familiar_words")
                ef_reading_comprehension_text_1 = cleaned_data.get(
                    "ef_reading_comprehension_text_1"
                )
                ar_letter_sound = cleaned_data.get("ar_letter_sound")
                ar_familiar_words = cleaned_data.get("ar_familiar_words")
                ar_reading_comprehension_text_1 = cleaned_data.get(
                    "ar_reading_comprehension_text_1"
                )
                m_total_score = cleaned_data.get("m_total_score")

                for field_name, value, max_value in [
                    ("ef_letter_sound", ef_letter_sound, 10),
                    ("ef_familiar_words", ef_familiar_words, 20),
                    (
                        "ef_reading_comprehension_text_1",
                        ef_reading_comprehension_text_1,
                        10,
                    ),
                    ("ar_letter_sound", ar_letter_sound, 10),
                    ("ar_familiar_words", ar_familiar_words, 20),
                    (
                        "ar_reading_comprehension_text_1",
                        ar_reading_comprehension_text_1,
                        10,
                    ...
                    if value is None:
                        ...
                        self.add_error(
                            field_name, "This value is greater that %s" % max_value
                        )

                if m_total_score is None:
                    self.add_error("m_total_score", "This field is required")
                elif registration_level == "level_one" and m_total_score > 50:
                    self.add_error("m_total_score", "This value is greater that 50")
                elif registration_level == "level_two" and m_total_score > 88:
                    self.add_error("m_total_score", "This value is greater that 88")
                elif m_total_score > 103:
                    self.add_error("m_total_score", "This value is greater that 103")
            else:
    ...
    def save(self, instance=None, request=None, number=None):
        ...
        if assessment_number == 1 and request.POST.get("mid_test_done") == "yes":
            instance.mid_test1 = {
                ...
                "Bridging_ASSESSMENT/ef_letter_sound": request.POST.get(
                    "ef_letter_sound"
                ),
                "Bridging_ASSESSMENT/ef_familiar_words": request.POST.get(
                    "ef_familiar_words"
                ),
                "Bridging_ASSESSMENT/ef_reading_comprehension_text_1": request.POST.get(
                    "ef_reading_comprehension_text_1"
                ),
                "Bridging_ASSESSMENT/ar_letter_sound": request.POST.get(
                    "ar_letter_sound"
                ),
                "Bridging_ASSESSMENT/ar_familiar_words": request.POST.get(
                    "ar_familiar_words"
                ),
                "Bridging_ASSESSMENT/ar_reading_comprehension_text_1": request.POST.get(
                    "ar_reading_comprehension_text_1"
                ),
                "Bridging_ASSESSMENT/m_total_score": request.POST.get("m_total_score"),
            ...
            instance.mid_test1 = {"Bridging_ASSESSMENT/mid_test_done": "no"}
            instance.mid_test2 = {"Bridging_ASSESSMENT/mid_test_done": "no"}
...
class BridgingServiceForm(forms.ModelForm):
    ...
    referal_wash = forms.ChoiceField(
        label=_("Referral wash"), widget=forms.Select, required=True, choices=CLM.YES_NO
    )
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Div(
                    ...
                    HTML(
                        '<span class="badge-form badge-pill" id="span_referal_other_specify">9</span>'
                    ),
...
class BridgingFollowupForm(forms.ModelForm):
    ...
    phone_call_follow_up_result = forms.ChoiceField(
        ...
        choices=(
            ...
            (
                ...
                _("Child referred to specialized services"),
            ),
    ...
    school_contacted_caretaker = forms.ChoiceField(
        label=_(
            "Have the child caregivers been contacted by the School Community Laison"
        ),
        widget=forms.Select,
        required=True,
        choices=(("yes", _("Yes")), ("no", _("No"))),
        ...
        self.helper.layout = Layout(
            ...
            Div(
                ...
                Div(
                    ...
                    HTML(
                        '<span class="badge-form badge-pill" id="span_pss_session_modality">3</span>'
                    ),
                    Div(
                        "pss_session_modality", css_class="col-md-2 multiple-checbkoxes"
                    ),
                    HTML(
                        '<span class="badge-form badge-pill" id="span_pss_session_number">4</span>'
                    ),
                    Div("pss_session_number", css_class="col-md-2"),
                    HTML(
                        '<span class="badge-form badge-pill" id="span_pss_parent_attended">5</span>'
                    ),
                    Div("pss_parent_attended", css_class="col-md-2"),
                    HTML(
                        '<span class="badge-form badge-pill" id="span_pss_parent_attended_other">6</span>'
                    ),
                ...
                Div(
                    ...
                    HTML(
                        '<span class="badge-form badge-pill" id="span_covid_session_modality">8</span>'
                    ),
                    Div(
                        "covid_session_modality",
                        css_class="col-md-2 multiple-checbkoxes",
                    ),
                    HTML(
                        '<span class="badge-form badge-pill" id="span_covid_session_number">9</span>'
                    ),
                    Div("covid_session_number", css_class="col-md-2"),
                    HTML(
                        '<span class="badge-form-2 badge-pill" id="span_covid_parent_attended">10</span>'
                    ),
                    Div("covid_parent_attended", css_class="col-md-2"),
                    HTML(
                        '<span class="badge-form-2 badge-pill" id="span_covid_parent_attended_other">11</span>'
                    ),
                ...
                Div(
                    ...
                    HTML(
                        '<span class="badge-form-2 badge-pill" id="span_followup_session_modality">13</span>'
                    ),
                    Div(
                    ...
                    HTML(
                        '<span class="badge-form-2 badge-pill" id="span_followup_session_number">14</span>'
                    ),
                    Div("followup_session_number", css_class="col-md-2"),
                    HTML(
                        '<span class="badge-form-2 badge-pill" id="span_followup_parent_attended">15</span>'
                    ),
                    Div("followup_parent_attended", css_class="col-md-2"),
                    HTML(
                        '<span class="badge-form-2 badge-pill" id="span_followup_parent_attended_other">16</span>'
                    ),
                ...
                Div(
                    ...
                    HTML(
                        '<span class="badge-form-2 badge-pill" id= "span_discussion_topic">18</span>'
                    ),
