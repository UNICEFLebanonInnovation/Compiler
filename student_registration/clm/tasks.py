    ...
    for ws in wb:
        for row in ws.rows:
            try:
                ...
                data['have_barcode'] = 'no'
                data['partner_id'] = 10
                data['internal_number'] = row[0].value
                data['round_id'] = row[1].value if row[1].value else 1
                ...
                data['student_p_code'] = row[19].value
                data['disability'] = row[20].value if row[20].value else 1
                data['student_id_number'] = row[21].value
                data['internal_number'] = row[22].value
                data['comments'] = row[23].value
                ...
                data['have_labour'] = row[30].value if row[30].value else 'no'
