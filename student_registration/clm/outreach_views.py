...
from .outreach_tables import  OutreachTable
from .outreach_filters import OutreachFilter
from .models import Outreach, CLMRound
from .outreach_forms import OutreachForm
from .utils import is_allowed_create, is_allowed_edit
from .outreach_serializers import OutreachSerializer
...
class OutreachExportViewSet(LoginRequiredMixin, ListView):
    ...
    model = Outreach
    queryset = Outreach.objects.filter(round__in=current_round)
