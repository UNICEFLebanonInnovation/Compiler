...
class Registration(TimeStampedModel):
    ...
    LABOURS = Choices(
        ...
        (
            ...
            _("Street Connected Work - includes vending and begging"),
        ),
        (
    ...
    LABOUR_CONDITION = Choices(
        ...
        (
            ...
            _("Works in extreme cold, heat or humidity"),
        ),
        ...
        (
            ...
            _("Maneuvers dangerous tools such as knives or operating heavy machinery"),
        ),
        (
        ...
        (
            ...
            _("Stating exposed to fumes (including argile and cigarettes)  and gas"),
        ),
    ...
    MSCC_PACKAGES = Choices(
        ...
        (
            ...
            _("Child Protection/Psychosocial support"),
        ),
    ...
    labour_type_specify = models.CharField(
        ...
        null=True,
        verbose_name=_(
            "Please specify (hotel, restaurant, transport, personal "
    ...
    type = models.CharField(
        max_length=100, blank=True, null=True, verbose_name=_("Type")
    )
    ...
    def has_previous_registration(self):
        previous_registration_exists = Registration.objects.filter(
            child_id=self.child.id, created__lt=self.created
        ).exists()
    ...
    def get_total_absent_days(registration_id):
        ...
        attendance_days = MSCCAttendanceChild.objects.filter(
            registration_id=registration_id, attended="No"
        ).count()
        if attendance_days:
...
class ProvidedServices(models.Model):
    ...
    category = models.CharField(
        max_length=100, blank=True, null=True, verbose_name=_("Category")
    )
    service_id = models.IntegerField(blank=True, null=True)
    completed = models.BooleanField(blank=True, default=False)
    required = models.BooleanField(blank=True, default=False)
    completion_date = models.DateField(
        blank=True, null=True, verbose_name=_("Completion date")
    )
...
class InclusionService(TimeStampedModel):
    ...
    dropout = models.CharField(
        max_length=100, blank=True, null=True, choices=YES_NO, verbose_name=_("Dropout")
    )
...
class DigitalService(models.Model):
    ...
    akelius_sessions_number = models.IntegerField(
        blank=True, null=True, verbose_name=_("Number of sessions per week")
    )
    ...
    akelius_child_equipped = models.CharField(
        ...
        verbose_name=_(
            "Is the child equipped at home to access the platforms (Based on Child and parents"
            " confirmation)"
        ),
    )
    akelius_change_literacy = models.CharField(
        ...
        verbose_name=_(
            "As a teacher, are you noticing a change in motivation & output about Literacy"
        ),
    )
    akelius_change_math = models.CharField(
        ...
        choices=NOTICING_CHANGE,
        verbose_name=_(
            "As a teacher, are you noticing a change in motivation & output about Math"
        ),
    )
    akelius_change_learning = models.CharField(
        ...
        choices=NOTICING_CHANGE,
        verbose_name=_(
            "As a teacher, are you noticing a change in attitude towards learning"
        ),
    )
...
class PSSService(models.Model):
    ...
    LIVING_ARRANGEMENT = Choices(
        ...
        (
            ...
            _("Living with single parent/caregiver"),
        ),
        (
            "Living with Mother/women-headed Household ",
            _("Living with Mother/women-headed Household"),
        ),
    ...
    caregivers_additional_parenting = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "If yes, would you like any additional parenting or psychosocial support?"
        ),
    )
    child_distress = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Are any of the children in your HH experiencing any "
    ...
    child_know_seek_help = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Does the child know where to seek help or support in case he is exposed to violence, abuse, or exploitation?"
        ),
    )
    child_protection_concern = models.CharField(
        ...
        verbose_name=_(
            "Does the facilitator identify any child protection concern or has the caregiver expressed any of the below signs on their children?"
        ),
    )
...
class HealthNutritionService(TimeStampedModel):
    ...
    DEVELOPMENT_DELAYS = Choices(
        ...
        (
            ...
            _("Cognitive (learning thinking, problem solving)"),
        ),
    ...
    MALNUTRITION_SCREENING = Choices(
        ...
        (
            ...
            _("SAM with Bilateral pitting oedema  (both feet puffy)"),
        ),
        (
            "At risk of malnutrition (MUAC 12.5-13.5 cm)",
            _("At risk of malnutrition (MUAC 12.5-13.5 cm)"),
        ),
    )
    registration = models.ForeignKey(
        Registration,
    ...
    infant_exclusively_breastfed = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "if yes, is it exclusively breastfeeding for infants between 0-6 months?(only brest milk no other liquids even water)"
        ),
    )
    # Caregivers of children 0-5 years
    ...
    immunization_record_screened = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Child immunization record screened (to check the integrated ECD milestones Cards based on the age of the child- or the national immunization Calendar)"
        ),
    )
    # Caregivers of children 0-5 years
    vaccine_missing = models.TextField(
        blank=True, null=True, verbose_name=_("write the name of vaccine missing")
    )
    # Caregivers of children 0-5 years
    ...
    child_vaccinated = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Is the child being vaccinated as per the National vaccination calendar?"
        ),
    )
    # Caregivers of children 0-5 years
    positive_parenting = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "positive parenting and dealing with difficult children without the use of harsh punishment?"
        ),
    )
    # Caregivers of children 0-5 years
    development_delays_identified = models.CharField(
        ...
        verbose_name=_(
            "Any delays in the development milestones  is being identified? (please to check the Integrated ECD milestones Cards based on the age of the child)"
        ),
    )
    ...
    respond_stressful_events = models.TextField(
        ...
        null=True,
        verbose_name=_(
            "How children of different ages respond to and understand stressful and traumatic events?"
        ),
    )
    # Caregivers of children 6-18 years
    physical_activity = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Is the child practicing physical activity at least twice a week"
        ),
    )
    # Caregivers of children 6-18 years
    accessing_reproductive_health = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "In case of a child marriage to ask if the child is accessing in reproductive health services"
        ),
    )
    ...
    counselling_date = models.DateField(
        blank=True, null=True, verbose_name=_("If yes (please provide session date)")
    )
    # Caregivers of children 0-5 years
    next_counselling_date = models.DateField(
        blank=True, null=True, verbose_name=_("Date of Next session")
    )
    # Caregivers of children 0-5 years
    ...
    health_nutrition_session_date = models.DateField(
        blank=True, null=True, verbose_name=_("if yes to write the date of the session")
    )
...
class HealthNutritionReferral(TimeStampedModel):
    ...
    referred_development_delays = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Was the child Referred for any observed developmental delays as per the milestones cards to?"
        ),
    )
    ...
    referred_anc_pnc = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Was a Pregnant lactating women/child referred  for ANC and PNC follow up  and to receive MMS (multivitamins) to PHC?"
        ),
    )
    phc_center = models.TextField(
        blank=True, null=True, verbose_name=_("If yes (please add name the PHC center)")
    )
    women_child_referred_iycf = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Was a Pregnant lactating women/child with challenges on breastfeeding referred to IYCF specialists?"
        ),
    )
    ...
    infant_child_referred_iycf = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Was a Children aged 6months to 59months with challenges on infant and young child feeding practice refeered to IYCF specialists and to receive Micronutrient supplements?"
        ),
    )
...
class EducationService(TimeStampedModel):
    ...
    registration_date = models.DateField(
        blank=True, null=True, verbose_name=_("Date of registration in the round")
    )
...
class EducationAssessment(TimeStampedModel):
    ...
    BARRIERS = Choices(
        ...
        (
            ...
            _("Working Full-time to support family"),
        ),
    ...
    pre_attended_arabic = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Did the Child Undertake Arabic Language Development Assessment"
        ),
    )
    ...
    pre_arabic_grade = models.IntegerField(
        blank=True, null=True, verbose_name=_("Grade")
    )
    pre_attended_language = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Did the Child Undertake Foreign Language Development Assessment"
        ),
    )
    ...
    pre_attended_math = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Did the Child Undertake Cognitive Development - Mathematics test"
        ),
    )
    ...
    pre_math_grade = models.IntegerField(blank=True, null=True, verbose_name=_("Grade"))
    ...
    barriers = models.CharField(
        ...
        choices=BARRIERS,
        verbose_name=_(
            "The main barriers affecting the child's "
            ...
            try:
                return "{}{}".format(
                    round(
                        (
                            (
                                float(self.post_arabic_grade)
                                - float(self.pre_arabic_grade)
                            )
                            / float(self.pre_arabic_grade)
                        )
                        * 100.0,
        ...
        if self.pre_math_grade and self.post_math_grade:
            try:
                return "{}{}".format(
                    round(
                        (
                            (float(self.post_math_grade) - float(self.pre_math_grade))
                            / float(self.pre_math_grade)
                        )
                        * 100.0,
                        2,
                    ),
            ...
            try:
                return "{}{}".format(
                    round(
                        (
                            (
                                float(self.post_language_grade)
                                - float(self.pre_language_grade)
                            )
                            / float(self.pre_language_grade)
                        )
                        * 100.0,
...
class YouthKitService(TimeStampedModel):
    ...
    previous_community_initiative = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Was the adolescent part of any previous community based initiative?"
        ),
    )
    enrollment_reason = models.CharField(
        ...
        null=True,
        verbose_name=_(
            "What is the reason for the adolescent enrollment in the programme?"
        ),
    )
    ...
    participate_volunteering = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Did the adolescent participate in any volunteering "
    ...
    community_initiatives_specify = models.TextField(
        blank=True, null=True, verbose_name=_("What is the initiative?")
    )
    ...
    adolescent_dropout_reason = models.TextField(
        blank=True, null=True, verbose_name=_("Reason for dropout")
    )
...
class FollowUpService(TimeStampedModel):
    ...
    follow_up_number = models.IntegerField(
        blank=True, null=True, verbose_name=_("Number")
    )
    ...
    parent_attended_meeting = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Did the child's caregiver attend parent meeting/engagment sessions"
        ),
    )
    ...
    meeting_number = models.IntegerField(
        blank=True, null=True, verbose_name=_("Number of sessions attended")
    )
    ...
    pfss_sessions_number = models.IntegerField(
        blank=True, null=True, default=0, verbose_name=_("Number number of sessions")
    )
...
class Referral(TimeStampedModel):
    ...
    LEARNING_PATH = Choices(
        ...
        (
            ...
            _("Repeat same level in next  school year"),
        ),
        ...
        (
            ...
            _("Progress to  Higher Level  in next school year"),
        ),
    )
    ...
    receive_needed_material = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Did the child receive all needed materials and resources (Stationery, Books, Learning bundle)?"
        ),
    )
    ...
    recommended_learning_path = models.CharField(
        ...
        verbose_name=_(
            "Based on the overall score, what is the recommended learning path/outcome?"
        ),
    )
...
class YouthReferral(TimeStampedModel):
    ...
    refer_tvet = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Did the partner refer youth who are above 18 to the TVET centers"
        ),
    )
    refer_innovation = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Did the partner refer youth who are above 18 to the  innovation hubs GIL?"
        ),
    )
...
class LegoService(TimeStampedModel):
    ...
    participating_education_sessions = models.CharField(
        ...
        choices=YES_NO,
        verbose_name=_(
            "Is the child participating in Education sessions supported by LEGO activities?"
        ),
    )
