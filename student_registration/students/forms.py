...
class TeacherForm(forms.ModelForm):
    ...
    is_active_current_round = forms.ChoiceField(
        label=_('The teacher still active in current round?'),
        widget=forms.Select,
        required=False,
        choices=Teacher.YES_NO,
    )
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Div(
                    ...
                    HTML('<span class="badge-form-2 badge-pill" id="span_teaching_hours_private_school">13</span>'),
                    Div('teaching_hours_private_school', css_class='col-md-3'),
                    HTML('<span class="badge-form-2 badge-pill" id="span_teaching_hours_dirasa">14</span>'),
                ...
                Div(
                    ...
                    HTML('<span class="badge-form-2 badge-pill" id="span_extra_coaching_specify">18</span>'),
