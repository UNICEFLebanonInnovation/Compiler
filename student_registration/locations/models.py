...
class Location(MPTTModel):
    ...
    type = models.ForeignKey(
        "LocationType", verbose_name="Location Type", on_delete=models.CASCADE
    )
...
class Center(TimeStampedModel):
    ...
    longitude = models.FloatField(
        blank=True, null=True, verbose_name=_("Center GPS (longitude)")
    )
    latitude = models.FloatField(
        blank=True, null=True, verbose_name=_("Center GPS (latitude)")
    )
    manager_name = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Center Manager name")
    )
    phone_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Phone number")
    )
    email = models.EmailField(
        blank=True, null=True, max_length=254, verbose_name="Email"
    )

    type = models.CharField(
        max_length=100, blank=True, null=True, choices=TYPE, verbose_name=_("Type")
    )
    ...
    p_code = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("P-Code")
    )
    is_active = models.BooleanField(
        default=False, blank=True, null=True, verbose_name=_("is active")
    )
    ...
    neaby_phcc = models.CharField(
        max_length=200, blank=True, null=True, verbose_name=_("Nearby PHCC name")
    )
    ...
    def total_female(self):
        ...
        return Registration.objects.filter(
            center=self.id, child__gender="Female"
        ).count()
    ...
    def total_disability(self):
        ...
        return (
            Registration.objects.filter(center=self.id)
    ...
    def total_disability_male(self):
        ...
        return (
            Registration.objects.filter(center=self.id, child__gender="Male")
            .exclude(child__disability__name_en="No")
            .count()
        )
    ...
    def total_disability_female(self):
        ...
        return (
            Registration.objects.filter(center=self.id, child__gender="Female")
            .exclude(child__disability__name_en="No")
            .count()
        )
    ...
    def total_lebanese(self):
        ...
        return Registration.objects.filter(
            center=self.id, child__nationality__code="LEB"
        ).count()
...
class ProgramStaff(TimeStampedModel):
    ...
    facilitator_name = models.CharField(max_length=200, verbose_name="Facilitator Name")
    phone_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name=_("Phone Number")
    )
