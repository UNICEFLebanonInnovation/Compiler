...
//  Followup
    var follow_up_type = $('select#id_follow_up_type').val();
     if (follow_up_type == 'Phone call'){
        $('#span_phone_call_number').removeClass('d-none');
        ...
        $('#span_house_visit_number').addClass('d-none');
        ...
        $('#span_caregiver_visit_number').addClass('d-none');
        ...
        $('#span_house_visit_number').removeClass('d-none');
        ...
        $('#span_phone_call_number').addClass('d-none');
        ...
        $('#span_caregiver_visit_number').removeClass('d-none');
