...
$(document).ready(function(){
    ...
    $(document).on('change', 'select#id_participation,  select#id_attended_arabic, select#id_attended_english,  select#id_attended_math,  ' +
     ...
     $(document).on('change', 'select#id_school_contacted_caretaker', function(){
       reorganizeForm_post_assessment();
    });
...
//    var attended_math = $('select#id_attended_math').val();
    ...
    var school_contacted_caretaker = $('select#id_school_contacted_caretaker').val();
...
//    }
 ...
 // covid_parent_attended
    ...
    $('#div_id_discussion_topic').addClass('d-none');
    $('#span_discussion_topic').addClass('d-none');
    if(school_contacted_caretaker == 'yes'){
        $('#div_id_discussion_topic').removeClass('d-none');
        $('#span_discussion_topic').removeClass('d-none');
    }
    else
    {
        $('#id_discussion_topic').val('');
    }

    $('#div_id_referal_other_specify').addClass('d-none');
