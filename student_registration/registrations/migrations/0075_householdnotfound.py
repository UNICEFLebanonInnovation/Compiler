# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2017-03-06 13:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('registrations', '0074_complaint_complaint_other_type_specify'),
    ]

    operations = [
        migrations.CreateModel(
            name='HouseholdNotFound',
            fields=[
                ...
                ('mother_full_name', models.CharField(blank=True, max_length=64L, null=True)),
                ...
                ('birthday_day', models.CharField(blank=True, choices=[(b'1', 1), (b'2', 2), (b'3', 3), (b'4', 4), (b'5', 5), (b'6', 6), (b'7', 7), (b'8', 8), (b'9', 9), (b'10', 10), (b'11', 11), (b'12', 12), (b'13', 13), (b'14', 14), (b'15', 15), (b'16', 16), (b'17', 17), (b'18', 18), (b'19', 19), (b'20', 20), (b'21', 21), (b'22', 22), (b'23', 23), (b'24', 24), (b'25', 25), (b'26', 26), (b'27', 27), (b'28', 28), (b'29', 29), (b'30', 30)], default=0, max_length=2, null=True)),
                ('gender', models.CharField(blank=True, choices=[('Male', '\u0630\u0643\u0631'), ('Female', '\u0627\u0646\u062b\u0649')], max_length=50, null=True)),
                ('relation_to_householdhead', models.CharField(blank=True, choices=[('head', '\u0623\u0646\u0627 \u0631\u0628 \u0627\u0644\u0623\u0633\u0631\u0629'), ('spouse', '\u0627\u0644\u0632\u0648\u062c\u0629'), ('parent', '\u0627\u0644\u0623\u0645/\u0627\u0644\u0623\u0628'), ('relative', '\u0623\u0642\u0627\u0631\u0628'), ('other', '\u0644\u064a\u0633 \u0645\u0646 \u0627\u0644\u0623\u0642\u0627\u0631\u0628')], max_length=50, null=True)),
                ('primary_phone', models.CharField(blank=True, max_length=50, null=True)),
                ('primary_phone_answered', models.CharField(blank=True, choices=[('me', '\u0623\u0646\u0627 \u0634\u062e\u0635\u064a\u0627'), ('relay', '\u0634\u062e\u0635 \u062f\u0627\u0626\u0645\u0627 \u064a\u0648\u0635\u0644 \u0627\u0644\u0631\u0633\u0627\u0644\u0629 \u0644\u064a'), ('notrelay', '\u0634\u062e\u0635 \u0645\u0627 \u0642\u062f \u0644\u0627 \u064a\u0648\u0635\u0644 \u0627\u0644\u0631\u0633\u0627\u0644\u0629 \u0644\u064a')], max_length=50, null=True)),
                ('id_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='household_not_found_id', to='students.IDType')),
            ],
            options={
                'ordering': ['id'],
            },
