# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2017-04-19 07:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday_month', models.CharField(blank=True, choices=[('1', '\u0643\u0627\u0646\u0648\u0646 \u0627\u0644\u062b\u0627\u0646\u064a'), ('2', '\u0634\u0628\u0627\u0637'), ('3', '\u0622\u0630\u0627\u0631'), ('4', '\u0646\u064a\u0633\u0627\u0646'), ('5', '\u0623\u064a\u0627\u0631'), ('6', '\u062d\u0632\u064a\u0631\u0627\u0646'), ('7', '\u062a\u0645\u0648\u0632'), ('8', '\u0622\u0628'), ('9', '\u0623\u064a\u0644\u0648\u0644'), ('10', '\u062a\u0634\u0631\u064a\u0646 \u0627\u0644\u0623\u0648\u0644'), ('11', '\u062a\u0634\u0631\u064a\u0646 \u0627\u0644\u062b\u0627\u0646\u064a'), ('12', '\u0643\u0627\u0646\u0648\u0646 \u0627\u0644\u0623\u0648\u0644')], default=0, max_length=2, null=True)),
                ...
                ('phone_prefix', models.CharField(blank=True, max_length=10L, null=True)),
                ...
                ('number_part1', models.CharField(blank=True, max_length=45L, null=True)),
                ('number_part2', models.CharField(blank=True, max_length=45L, null=True)),
                ('old_id_number', models.CharField(blank=True, max_length=45L, null=True)),
        ...
        migrations.AddField(
            ...
            name='complaint_urgent',
            field=models.BooleanField(default=False),
        ),
        migrations.AddField(
            model_name='complaint',
            name='missing_child',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ChildNotFound', to='registrations.HouseholdNotFound'),
        ),
    ]
